...
UploadVideo.prototype.uploadFile = function(file) {
    ...
    var uploader = new MediaUploader({
        ...
        onComplete: function(data) {
            ...
            $("#video_id_map").val(this.videoId); // Передача номера видео в скрытое поле формы для отправки в бд
        }.bind(this)
    });
            ...
            if (response.error) {
                ...
                switch (uploadStatus) {
                    ...
                    case 'processed':
                        ...
                        sendDataToBd(); //Вызов функции отправки данных в базу на сервере (из файла my-script.js)
                        break;
