<?php
    ...
    $query_select_reserve = "SELECT * FROM road_case";// Резервирую за скриптом testupload 3 строки
    ...
    while ($row = mysqli_fetch_array($result_select_reserve)) {
        ...
        $query_reserve = "UPDATE road_case SET server_video = 'yes', videos = '', dataa = '', upload1 = '', upload2 = '' WHERE newid = '$id_reserve'";
