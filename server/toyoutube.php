    ...
    if ($client->getAccessToken()) {
        ...
        try {
            ...
            while (!$status && !feof($handle)) {
                ...
                mysqli_query($dbc, $query) or die ("Ошибка имя файла: " . $filename . " проверить");
            }
            ...
            $results_upload = array();
            array_push($results_upload, array('video_id' => $video_id, 'filename' => $filename));
            echo json_encode(array('otvet' => $results_upload));
